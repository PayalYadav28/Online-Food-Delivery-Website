...
<head>
  ...
  <link href="register1.css"rel="stylesheet">
            ...
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                ...
                <%
		     	...
		     	{%>
					 <li class="nav-item">
                <a class="nav-link" href="register.jsp"><%=u.getName() %></a>
              </li>
...
<input class="form-control" name="uname" type="text"><br>
</div>
<div class="form-group">
...
<div class="text-center dont-have" id="dont">Already have an account? <a href="login.jsp"id="logina">Login</a></div>
</div>
</div>
</div>
</div>
